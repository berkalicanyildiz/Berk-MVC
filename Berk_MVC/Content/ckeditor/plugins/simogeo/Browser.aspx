<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Browser.aspx.cs" Inherits="televizyon_reklam.ckeditor.plugins.simogeo.Browser" %>
...
<body>
    ...
    <div>
        ...
        <button id="home" name="home" type="button" value="Home">
            &nbsp;</button>
        <h1>
        </h1>
        ...
        <button id="upload" name="upload" type="submit" value="Upload">
        </button>
        <button id="newfolder" name="newfolder" type="button" value="New Folder">
        </button>
        <button id="grid" class="ON" type="button">
            &nbsp;</button>
