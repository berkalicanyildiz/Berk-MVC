...
public class filemanager : IHttpHandler, System.Web.SessionState.IReadOnlySessionState
{
    //===================================================================
    //==================== EDIT CONFIGURE HERE ==========================
    //===================================================================

    public string IconDirectory = "/ckeditor/plugins/simogeo/images/fileicons/"; // Icon directory for filemanager. [string]
    public string[] imgExtensions = new string[] { ".jpg", ".png", ".jpeg", ".gif" }; // Only allow this image extensions. [string]
    ...
    private string getOnlyFolderInfo(string path)
    {
        DirectoryInfo RootDirInfo = new DirectoryInfo(HttpContext.Current.Server.MapPath(path));
        StringBuilder sb = new StringBuilder();
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (context.Request["mode"])
        {
            ...
            case "getonlyfolder":
                context.Response.ContentType = "application/json";
                context.Response.ContentEncoding = Encoding.UTF8;
                context.Response.Write(getOnlyFolderInfo(context.Request["path"]));
                break;
